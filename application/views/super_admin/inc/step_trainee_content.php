        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 m-t-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>super_admin/trainee_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Trainee List">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body p-0">
                            <div class="bs-stepper linear">
								...
								<form action="<?= base_url() ?>super_admin/nid_chack" method="post" enctype="multipart/form-data">
                                    <div id="logins-part" class="content active dstepper-block" role="tabpanel" aria-labelledby="logins-part-trigger">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">NID/Birth Registration Number</label>
                                            <input type="number" name="nid" class="form-control" id="exampleInputEmail1" placeholder="Enter NID/Birth Number">
                                        </div>
