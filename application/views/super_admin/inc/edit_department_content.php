        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 m-t-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>super_admin/department_list/" class="btn btn-info btn-lg tooltips" >
            ...
            <div class="row">
                ...
                <form action="<?= base_url('super_admin/update_department')?>" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="card">
