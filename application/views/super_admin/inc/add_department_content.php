    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="<?= base_url() ?>super_admin/save_department" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field-9" class="control-label">Department Name</label>
                                                <input type="text" class="form-control" id="field-1" name="dept_name" required="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field-8" class="control-label">Department Code</label>
										...
										<div class="col-md-12">
                                            <div class="form-group">
												...
												<select class="form-control col-md-12 col-xs-12" name="inst_name" id="add_religion" required="">
