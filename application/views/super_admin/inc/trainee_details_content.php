        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>super_admin/edit_trainee/<?= $data->trainee_id ?>" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
                                <i class="fas fa-pencil"></i>Update Trainee
                            </a>
                        </div>
                    </div>
                </div>
