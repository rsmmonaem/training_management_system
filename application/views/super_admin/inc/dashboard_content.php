			...
			<div class="row">
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-info">
						...
						<a href="<?= base_url() ?>super_admin/trainee_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-success">
						<div class="inner">
							<h3><?php echo $pending_trainee?></h3>
						...
						<a href="<?= base_url() ?>super_admin/pending_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-danger">
						...
						<a href="<?= base_url() ?>super_admin/department_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
					</div>
				</div>
				...
				<div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        ...
                        <a href="<?= base_url() ?>super_admin/certificate_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
				<div class="col-lg-3 col-6">
					<!-- small box -->
					<div class="small-box bg-info">
						...
						<a href="<?= base_url() ?>super_admin/institute_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        ...
                        <a href="<?= base_url() ?>super_admin/user_modification_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        ...
                        <a href="<?= base_url() ?>super_admin/news_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <!-- small box -->
                    <div class="small-box bg-warning">
                        ...
                        <a href="<?= base_url() ?>super_admin/slider_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
				<!-- ./col -->
			</div>
			...
			<div class="row">
				...
				<section class="col-lg-7 connectedSortable">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="<?php base_url();?>super_admin/trainee_list" class="btn btn-primary">Show More</a>
                        </div>
                    </div>
                ...
                <section class="col-lg-5 connectedSortable">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="<?php base_url();?>super_admin/pending_list" class="btn btn-primary">Show More</a>
                        </div>
                    </div>
                    <div class="card">
