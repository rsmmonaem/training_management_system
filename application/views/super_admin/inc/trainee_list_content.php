                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" data-placeholder="Any" style="width: 100%;" id="institute" name="institute">
                                                <?php
                                                
                                                foreach ($institute as $row){
                                                        echo '<option class="form-control" value="">'.$row->inst_name.'</option>';
                                                    }
                                                ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" style="width: 100%;">
                                                <option class="form-control" selected>Web Design</option>
                                                <option class="form-control">Web Design</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                foreach($data as $row): ?>
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            ...
                                            <!-- <a class="btn btn-success btn-sm" href="<?= base_url() ?>super_admin/trainee_certificate/<?= $row->trainee_id  ?>">
                                                <i class="fas fa-certificate"></i> Certificate
                                            </a> -->
                                            <a class="btn btn-info btn-sm" href="<?= base_url() ?>super_admin/edit_trainee/<?= $row->trainee_id  ?>">
