        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 m-t-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>deo_admin/department_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
            ...
            <div class="row">
                ...
                <form action="<?= base_url('deo_admin/update_department/'.$data->dept_id)?>" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="">
