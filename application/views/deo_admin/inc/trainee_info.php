        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 m-t-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>deo_admin/trainee_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Trainee List">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body p-0">
                                    ...
                                    <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                                        ...
                                        <form action="<?= base_url() ?>deo_admin/save_trainee" method="post" enctype="multipart/form-data">
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" value="<?= $nid ?>"  class="form-control" id="field-1" name="trainee_nid" readonly>
                                                            </div>
                                                        </div>
