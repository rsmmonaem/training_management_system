        ...
        <div class="container-fluid">
            <div class="card m-b-30 m-t-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>deo_admin/add_another_course/<?= $histry2->trainee_nid ?>" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
