        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 m-t-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>institute_admin/department_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Company List">
            ...
            <div class="row">
                ...
                <form action="<?= base_url('institute_admin/update_department')?>" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="card">
							<input name="dept_id"value="<?=$data->dept_id?>" type="hidden">
                            <div class="card-body">
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="field-1" name="dept_name" value="<?= $data->dept_name ?>" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field-1" class="control-label">Department Code</label>
                                                <input type="text" class="form-control" id="field-1" name="dept_code" value="<?= $data->dept_code ?>">
                                            </div>
                                        </div>
										<div class="col-md-12">
                                            <div class="form-group">
