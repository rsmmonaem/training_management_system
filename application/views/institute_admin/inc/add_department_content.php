    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="<?= base_url() ?>institute_admin/save_department" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="">
                                    ...
                                    <div class="row">
										...
										<div class="col-md-12">
                                            <div class="form-group">
                                                <label for="field-7" class="control-label">Institute</label>
												<input type="text" value="<?=$full_name ?>" class="form-control" id="field-1" name="inst_name" required="" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
