									...
									<div class="col-md-12 col-sm-3 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-12 col-xs-12"  name="trainee_education" id="phone"  placeholder="Educational Qualification (Year)" required="required" type="number" autocomplete="off">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-12 col-xs-12"   name="trainee_past_training" id="phone"  type="text" autocomplete="off">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
