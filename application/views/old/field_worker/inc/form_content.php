            ...
            <div class="col-lg-6">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14">Select2 is a jQuery based replacement for select boxes.
                        ...
                        <h6 class="mt-2 text-muted">Multiple Select</h6>
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="m-t-20">
                            <label class="mb-0"><b>All the options</b></label>
                            <p class="text-muted font-13">
                        ...
                        <div class="m-t-20">
                            <label class="mb-0"><b>Position</b></label>
                            <p class="text-muted font-13">
                        ...
                        <div class="m-t-20">
                            <label class="mb-0"><b>textareas</b></label>
                            <p class="text-muted font-13">
            ...
            <div class="col-lg-6">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14">Examples of twitter bootstrap datepicker.</p>
                ...
                <div class="card m-b-30">
                    <div class="card-body bootstrap-select-1">
                        ...
                        <p class="text-muted font-14">An example of Bootstrap Material DatePicker.</p>
                        <div class="row form-material">
                            <div class="col-md-6">
                                <label class="text-muted">Default Material Date Picker</label>
                                <input type="text" class="form-control" placeholder="2017-06-04" id="mdate">

                                <label class="text-muted mt-3">Default Material Date Timepicker</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="text-muted mt-3">Min Date set</label>
                ...
                <div class="card m-b-30">
                    <div class="card-body bootstrap-select-1">
                        ...
                        <p class="text-muted  font-14">Simple jQuery Based Color and Gradient Picker - asColorPicker. </p>
                        <div class="row">
                            <div class="col-md-12 col-xl-4">
                                <h6 class="text-muted">Simple mode</h6>
                                <input type="text" class="colorpicker form-control" value="#079c9e" />
                            </div>
                            <div class="col-md-12 col-xl-4">
                                <h6 class="text-muted">Gradiant mode</h6>
                                <input type="text" class="gradient-colorpicker form-control" value="#ffa784" />
                            </div>
                            <div class="col-md-12 col-xl-4">
                                <h6 class="text-muted">Complex mode</h6>
            ...
            <div class="col-xl-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p class="text-muted  font-14">A mobile and touch friendly input spinner component for Bootstrap</p>
                        <div class="row">
                            <div class="col-md-6">
                                <form>
                                    <div class="form-group">
            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14">Input masks can be used to force the
            ...
            <div class="col-xl-12">
                <div class="card ">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14">DropzoneJS is an open source library
