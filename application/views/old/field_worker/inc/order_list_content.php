    ...
    <div class="card-body">
        <div class="btn-group">
            <div>
                ...
                <a href="<?= base_url() ?>field_worker/create_order/" class="btn btn-warning btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Inventory List">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php $i = 1;
                        foreach ($this->omm->getorder_list_fw() as $row) : ?>
                            <tr>
                                <td><?= $i++ ?></td>
                                <td><?= $row->order_date ?></td>
                                <td><a href="<?= base_url() ?>field_worker/order_view/<?= $row->order_no ?>" type="button" class="btn btn-info">
                                        <?= $row->order_no ?>
                                    </a></td>
