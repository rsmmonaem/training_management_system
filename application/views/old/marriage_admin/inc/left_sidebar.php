    ...
    <div class="sidebar-inner slimscrollleft" id="sidebar-main">
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="<?= base_url() ?>marriage_admin/add_kazi" class="waves-effect"><i class="fas fa-user-tie"></i><span>Kazi</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                </li>
                <li>
                    <a href="<?= base_url() ?>marriage_admin/add_imam" class="waves-effect"><i class="fas fa-user-tie"></i><span>Imam</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                </li>
                <li>
                    <a href="<?= base_url() ?>marriage_admin/add_purohit" class="waves-effect"><i class="fas fa-user-tie"></i><span>Purohit</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                </li>

				<li>
                    <a href="<?= base_url() ?>marriage_admin/birth" class="waves-effect"><i class="fas fa-user-tie"></i><span>Add Marriage</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                </li>
