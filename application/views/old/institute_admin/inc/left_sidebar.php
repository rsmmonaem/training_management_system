    ...
    <div class="sidebar-inner slimscrollleft" id="sidebar-main">
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="<?= base_url() ?>institute_admin/add_institute" class="waves-effect"><i class="fas fa-school"></i><span>Add Institute</span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                </li>
				<li>
