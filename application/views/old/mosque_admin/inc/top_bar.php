...
if ($user_type !== "mosque_admin") {
	...
	$this->session->set_flashdata('You are Not mosque_admin', 'logged_out');
	redirect("login");
}
                ...
                <ul class="list-inline float-right mb-0">
                    <li class="list-inline-item dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <a class="dropdown-item" href="<?= base_url() ?>mosque_admin/update_profile"><i class="mdi mdi-account-circle "></i> Profile</a>
