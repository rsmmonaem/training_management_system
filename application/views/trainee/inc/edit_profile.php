    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="col-md-12" action="<?php echo base_url('trainee/update_profile/'.$user_info->u_id)?>" method="post">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="field-1" name="user_name" value="<?= $user_info->user_name?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
