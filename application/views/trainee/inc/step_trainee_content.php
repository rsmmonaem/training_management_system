        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 m-t-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>trainee/trainee_list/" class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Trainee List">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body p-0">
                            <div class="bs-stepper linear">
								...
								<form action="<?= base_url() ?>trainee/nid_chack" method="post" enctype="multipart/form-data">
