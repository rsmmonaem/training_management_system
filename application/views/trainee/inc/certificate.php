                    ...
                    <div class="imgpart" style="background-image: url(<?php echo base_url().'assets/';?>backend/img/Vector.png);">
                        <div class="allpart" style="background-image: url(<?php echo base_url().'assets/';?>backend/img/group2.png);">
                            ...
                            <div class="mainpart">
                                ...
                                <div class="info">
                                    <h2 style="font-size: 30px"><?= $histry_row->trainee_name ?></h2>
                                    <hr>
                                    <p style="font-size: 20px">Has successfully completed</p>
                                    <p style="font-size: 20px" ><?= $histry_row->dept_name ?> Course</p>
                                    <p style="font-size: 20px" >From, <?= $histry_row->inst_name ?> .</p>
                                    <p style="font-size: 20px" ><?php echo date("D-M-Y");?></p>
                                </div>

                                <img src="<?= base_url() ?><?= $histry_row->trainee_qr_code_file ?>" width="20%" class="qr-code">
