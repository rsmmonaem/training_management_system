    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="<?= base_url() ?>trainee/save_another_course" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="">
									...
									<div class="col-md-12 col-sm-3 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-12 col-xs-12" value="<?= $data->trainee_education ?>"  name="trainee_education" id=""  placeholder="Educational Qualification (Year)" required="required" type="Number" autocomplete="off">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-12 col-xs-12" value="<?= $data->trainee_past_training ?>"  name="trainee_past_training" id=""  type="text" autocomplete="off">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
